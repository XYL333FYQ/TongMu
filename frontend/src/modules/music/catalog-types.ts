import type { MusicQuality } from './source-resolver'

export type NcmCatalogSearchType = 'song' | 'playlist' | 'album' | 'artist'
export type MusicCatalogSearchType = NcmCatalogSearchType
...
export interface MusicCatalogAlbum extends MusicCatalogAlbumSummary {
  description: string | null
  tracks: MusicCatalogTrack[]
}
...
export type MusicCatalogSearchItem =
  | MusicCatalogTrack
